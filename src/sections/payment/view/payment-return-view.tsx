...
const RE_SERVICE_CODE = import.meta.env.VITE_APP_RE_SERVICE;
...
export function PaymentReturnView() {
  ...
  const goToReExam = () => navigate('/phuckhao');
  ...
  useEffect(() => {
    ...
    orderService.getOrderReDetails({ code: orderCode }).then(
      (response: any) => {
  ...
  useEffect(() => {
    ...
    const link = `${RE_SERVICE_CODE} ${orderCode} ${fullname}`;
      ...
      >
        <Card variant="outlined">
          <CardHeader
            title={
              <Typography variant="h5">
                Thông tin thanh toán phúc khảo
              </Typography>
            }
          />
          ...
          <CardContent>
            {exam && (
              <Box sx={{ flexGrow: 1 }}>
                {/* Sử dụng CSS Grid thay vì MUI Grid để tránh lỗi */}
                <Box sx={{ 
                  display: 'grid',
                      ...
                      <CardContent sx={{ px: 0 }}>
                        <Box sx={{ mx: 2 }}>
                          ...
                          <Typography variant="subtitle1" component="div" color="primary">
                            Mã đăng ký phúc khảo: {orderCode}
                          </Typography>
                        ...
                        <TableContainer component={Paper} sx={{ mt: 3 }}>
                          <Table aria-label="customized table">
                            <TableHead>
                              <TableRow>
                                <StyledTableCell align="left">Môn đăng kí phúc khảo</StyledTableCell>
                    ...
                    {status === "PENDING" && totalPrice > 0 && (
                      <Alert severity="warning" sx={{ my: 1 }}>
                        <Typography component="div" variant="body1" color="error">
                          Lưu ý: bạn cần hoàn tất việc thanh toán trong vòng 24 giờ tính từ ngày đăng ký! Hệ thống sẽ tự động cập nhật kết quả thanh toán.
                        </Typography>
                            ...
                            <Box sx={{ textAlign: 'left' }}>
                              <Alert severity="info" sx={{ m: 1 }}>
                                ...
                                <Typography variant="body1" fontWeight="bold">
                                  {RE_SERVICE_CODE} {orderCode} {fullname}
                                </Typography>
                              </Alert>
                            </Box>
                          </Box>
